...
/**
 * @brief getWordCount reads through the specified nGram file word by word to count the total number of words as delineated by whitespaces
 * @param input provides the ifstream opened to the nGramFile whose words will be counted
 * @param nGramFilename allows the file to be reseted after counting by closing input and reopening it to the same fileName.
